...
<<<<<<< HEAD
<div class="max-w-full mx-auto grid grid-cols-2 md:grid-cols-2 gap-1 mb-6 items-center">
=======
<div class="max-w-full mx-auto grid grid-cols-4 gap-1 mb-6 justify-center">
>>>>>>> b87766c (minor fixes)
